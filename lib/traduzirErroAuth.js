...
const MENSAGENS_POR_CODIGO = {
  ...
  // Passkeys / WebAuthn (Face ID, Touch ID, chaves de segurança) — estes códigos
  // vêm de WebAuthnError (auth-js), não de AuthError, mas usam a mesma propriedade
  // "code", por isso encaixam na mesma tabela.
  ERROR_CEREMONY_ABORTED: 'Operação cancelada.',
  ERROR_INVALID_DOMAIN: 'Este site não está configurado corretamente para usar chaves de acesso. Contacta o suporte.',
  ERROR_INVALID_RP_ID: 'Este site não está configurado corretamente para usar chaves de acesso. Contacta o suporte.',
  ERROR_INVALID_USER_ID_LENGTH: 'Não foi possível registar a chave de acesso. Tenta novamente.',
  ERROR_MALFORMED_PUBKEYCREDPARAMS: 'Não foi possível registar a chave de acesso. Tenta novamente.',
  ERROR_AUTHENTICATOR_GENERAL_ERROR: 'O dispositivo não conseguiu concluir a operação. Tenta novamente.',
  ERROR_AUTHENTICATOR_MISSING_DISCOVERABLE_CREDENTIAL_SUPPORT: 'Este dispositivo não suporta chaves de acesso (Face ID/Touch ID).',
  ERROR_AUTHENTICATOR_MISSING_USER_VERIFICATION_SUPPORT: 'Este dispositivo não suporta verificação por Face ID/Touch ID.',
  ERROR_AUTHENTICATOR_PREVIOUSLY_REGISTERED: 'Este dispositivo já tem uma chave de acesso registada para esta conta.',
  ERROR_AUTHENTICATOR_NO_SUPPORTED_PUBKEYCREDPARAMS_ALG: 'Este dispositivo não é compatível com chaves de acesso.',
  ERROR_AUTO_REGISTER_USER_VERIFICATION_FAILURE: 'Não foi possível confirmar a tua identidade. Tenta novamente.',
  ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY: 'Operação cancelada ou não autorizada pelo dispositivo.'
}
...
const PADROES_MENSAGEM = [
  ...
  { padrao: /auth session missing/, texto: 'O link de recuperação expirou ou já foi usado. Pede um novo.' },
  { padrao: /network|fetch failed|failed to fetch/, texto: 'Não foi possível ligar ao servidor. Verifica a tua ligação à internet.' },
  { padrao: /does not support webauthn/, texto: 'Este dispositivo ou navegador não suporta Face ID/Touch ID.' },
  { padrao: /webauthn ceremony failed/, texto: 'Não foi possível concluir a operação com o dispositivo. Tenta novamente.' }
]
