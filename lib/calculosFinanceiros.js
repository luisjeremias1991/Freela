...
// atividade guardada no perfil — usada tanto aqui (Painel/Orçamento) como no
// Simulador, para as duas nunca poderem divergir.
export function percentagemRendimentoRelevanteSS(perfil) {
  return perfil?.categoria_coeficiente === COEFICIENTE_VENDA_DE_MERCADORIAS
...
export function calcularSSRecibo(recibo, perfil) {
  ...
  return recibo.valor * percentagemRendimentoRelevanteSS(perfil) * taxaSS
}
